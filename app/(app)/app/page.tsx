  ...
  return (
    ...
    >
      ...
      {/* Em desktop (≥1024px) o navegador de mês vive na TopbarDesktop e o
          wrapper acima fica oculto (mobile-only); aqui os badges (moedas +
          streak) aparecem alinhados à direita, acima do conteúdo de 2 colunas. */}
      {homeBadges && (
        <div
      ...
      {/* ── SHEET: Streak Freeze (compra mínima) ─────────────────────────────── */}
      <StreakFreezeSheet
